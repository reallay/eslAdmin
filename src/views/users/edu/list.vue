...
<!--      </el-select>-->
    ...
    >
      ...
      <el-table-column label="province" width="110">
        <template slot-scope="scope">
          {{ scope.row.province }}
        </template>
      </el-table-column>
      <el-table-column label="city" width="110">
        <template slot-scope="scope">
          {{ scope.row.city }}
        </template>
      </el-table-column>
      <el-table-column label="district" width="110">
      <template slot-scope="scope">
        {{ scope.row.district }}
      </template>
    </el-table-column>
...
import { userList, editUserInfo, deleteUser, vipList, changeVipLevel, userObjectList,educatorList } from '@/api/member'
